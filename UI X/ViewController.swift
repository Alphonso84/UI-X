...
//        let detailViewController = storyboard?.instantiateViewController(withIdentifier: "HeroDetailViewController")
        
      // HeroDetailViewController().heroImage.image = HeroesArray[indexPath.row].picture
     //  HeroDetailViewController().heroBio.text = "Test this is a test this is a test this is a test"
